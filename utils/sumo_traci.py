...
class Vehicles:
    ...
    def __update_state(self, step):
        ...
        for id in self.vehicles:
            ...
            traci.vehicle.slowDown(vehID=veh_id, speed=veh_info.iloc[0]["speed"], duration=0.04)
...
if __name__ == "__main__":
    ...
    df = pd.read_csv("/data/HighD/highD/processed/12_tracks.csv")
    df_init = pd.read_csv("/data/HighD/highD/processed/12_tracksMeta.csv")
